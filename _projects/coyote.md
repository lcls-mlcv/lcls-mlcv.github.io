...
It leverages state-of-the-art deep learning models, YOLO, optimized through ONNX Runtime and multi-build performance tuning, to predict crystal positions within few milliseconds.
