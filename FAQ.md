...
If the website does not load the theme, the layout looks weird, and all links are broken, being the main page displayed [this way](https://github.com/alshedivat/al-folio/blob/main/assets/img/template_error.png),
